...
const Template4 = ({ data }) => {
  ...
  return (
    <div className="container my-4">
      ...
      <div className="border rounded p-4" style={{ backgroundColor: '#e0f2fe' }}>
        {/* Title */}
        ...
        <div className="d-flex justify-content-between align-items-start mb-4 flex-wrap">
          <div
            ...
            style={{ width: '120px', height: '120px', border: '2px solid #2563eb' }}
          >
            <img
        ...
        {/* Bill/Ship To and Invoice Details */}
        ...
        <div className="p-3 d-flex justify-content-between flex-wrap text-start">
          <div className="flex-fill pe-3 border" style={{ minWidth: '200px', borderColor: '#2563eb' }}>
            <div className='p-2'>
          ...
          <div className="flex-fill text-center py-4 border" style={{ minWidth: '200px', borderColor: '#2563eb' }}>
            <p className="fw-bold">Receiver's Signature</p>
            <div style={{ borderBottom: '1px solid #2563eb', width: '60%', margin: '0 auto' }}></div>
          </div>

          <div className="flex-fill ps-3 d-flex flex-column align-items-end justify-content-end text-end border" style={{ minWidth: '200px', borderColor: '#2563eb' }}>
